...
public class Walls2Json {
	private static String jsonFileName = "wallpapers.json",
			authorName = "Pitched Apps", linkPrefix = "https://github.com/asdfasdfvful/Pitched-Wallpapers/tree/master/Material_Glass/",
			copyright = "Images were found online, and the rights go to the original creator.";
